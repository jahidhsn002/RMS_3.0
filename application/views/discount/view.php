		...
		<table class="table white table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>{value}</td>
					<td class="text-right">
						<a class="btn btn-sm btn-primary" href="<?php echo site_url('discount/edit'); ?>/{id}"><span class="glyphicon glyphicon-edit"></span></a>
						<a class="btn btn-sm btn-danger" href="<?php echo site_url('discount/remove'); ?>/{id}"><span class="glyphicon glyphicon-remove-circle"></span></a>
					</td>
				</tr>
				{/discount}
			</tbody>
