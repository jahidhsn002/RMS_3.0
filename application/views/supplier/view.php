		...
		<table class="table white table-bordered">
			<thead>
				<tr>
					...
					<th data-priority="6">Designation</th>
			...
			<tbody>
				...
				<tr>
					...
					<td>{contact}</td>
					<td class="text-right">
						<a class="btn btn-sm btn-primary" href="<?php echo site_url('supplier/edit'); ?>/{id}"><span class="glyphicon glyphicon-edit"></span></a>
						<a class="btn btn-sm btn-danger" href="<?php echo site_url('supplier/remove'); ?>/{id}"><span class="glyphicon glyphicon-remove-circle"></span></a>
					</td>
				</tr>
				{/supplier}
			</tbody>
